...
**What it describes:**
The *thing the knop represents* — its referent.

**Examples:**

* classifications (e.g. schema:Person)
* names, descriptions, related websites
* for [[mesh-resource.knop.payload]]:
...
**What it describes:**
The **knop itself**, refered to via the [[mesh-resource.component.knop-handle]], independent of its payload or referent.
Nodes are [[transposable|principle.transposability]] across meshes, so each must carry its own administrative metadata.

**Examples:**

* **Per-knop licensing and copyright**
  * Repository-level LICENSE files do not travel with knops
...
**Typical subject:** [[_knop-handle|mesh-resource.component.knop-handle]]

**Mnemonic:**
*“If it summarizes the *state of the knop*, it lives in `_meta`.”*
...
* `meta:KnopCreation`
* `meta:KnopWeave`, `meta:PayloadWeave`
...
**Versioned versions:** Yes (per weave, e.g. `2025-11-29_0647_59_v1/`)
...
* _opslog versions are conceptually more like distinct datasets than versions of an evolving dataset
