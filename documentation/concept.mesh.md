...
| `ns/djradon/index.html`                                         | [[concept.resource-page]] | resource page (content)      |
...
- **[[Resource pages|concept.resource-page]]**: index.html files present in every mesh folder after weaving
...
- all resource folders should contain a [[concept.resource-page]] that makes there IRIs servable/dereferenca
- 
...
- IRIs must return meaningful content when dereferenced
  - [[concept.resource-page]] provide human-readable information for [[facet.filesystem.folder]]-based resources
