...
Metadata about a knop's flows' [[mesh-resource.component.flow-slice.version]]s mostly lives here too, eliminating the need to keep separate metadata in the knop component. Also may contain metadata about the assets folder.
