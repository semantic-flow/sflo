...
Every node flow has at least two concrete snapshots: [[mesh-resource.node-component.flow-snapshot.default]] and [[mesh-resource.node-component.flow-snapshot.working]].
