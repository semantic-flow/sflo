...
It can be contained in any [[folder._knop]], i.e., only Nodes get assets trees.
...
- _templates can contain html files to be used when generating [[concept.resource-page]] for the containing [[mesh-resource.knop]] or its sub-resources.
