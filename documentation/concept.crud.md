...
### Manual Manipulation
- Pre-built knop folder structures with user-editable flows and other components
- Manual mesh resource creation (knops; flows, versions, distributions and other components)
- File-system based editing workflows
- Validation of hand-crafted mesh structures

### API-Driven Node Manipulation
- Flow-service API endpoints for programmatic knop creation
- Support for root knop initialization
...
- System-generated reference and dataset knops
