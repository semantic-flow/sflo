...
**[[mesh-resource.component.flow-slice.default-slice]]** (the latest "woven" flow versions, `_default/`) should not be modified directly by users, but will be updated "on weave" if the [[mesh-resource.knop-component.flow-slice.working]] has evolved.
