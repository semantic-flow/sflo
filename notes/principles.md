...
Maybe it's occasionally avoidable when working files are outside the repo, but ArtifactResolutionTargets should be URLs or repo targets, as local path relations aren't consistent between devices. th